...
PICS = (environ.get('PICS', 'https://radare.arzfun.com/api/tg/photo?id=AgACAgUAAxkBAAIsnGXjO8yUSJLiJJRpfza-OUKc7F5eAAKtuzEbf5MgV7IHsDiTb3pIAQADAgADeQADNAQ')).split()
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/cf24c19270897a8bebbaf.jpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002069762419').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1691590963').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL',"-1002002749420")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dmongo047:KUy9SbYq72ic30Ap@pratik0.8hn8ylz.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "pratik0")
...
VERIFY2_API = environ.get('VERIFY2_API', "4d4a425471ead73f4c53a77bfe3bbc01fd525173")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'shrinkme.io')
SHORTLINK_API = environ.get('SHORTLINK_API', '4d4a425471ead73f4c53a77bfe3bbc01fd525173')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'True')), True)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movieqrpstrasbbe')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/allmovieishereis')
MSG_ALRT = environ.get('MSG_ALRT', 'ᴠᴀʟᴀʀ ᴍᴏʀɢʜᴜʟɪs!')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002092302121'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Mrstark8923')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002113825953')).split()]
...
CAPTION_BUTTON_URL = "https://t.me/allmovieishereis"
